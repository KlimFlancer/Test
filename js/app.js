(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-product")) new swiper_core_Swiper(".slider-product__slider", {
            ...
            parallax: true,
            navigation: {
                prevEl: ".arrows .arrow-product_prev",
                nextEl: ".arrows .arrow-product_next"
            },
            on: {}
        });
    }
